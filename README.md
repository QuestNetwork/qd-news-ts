...
It's not all qDesk though, if you are using [Quest OS](https://github.com/QuestNetwork/quest-os-js) in your applications you can use it in your existing app.
